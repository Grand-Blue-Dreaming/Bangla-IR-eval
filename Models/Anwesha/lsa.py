        ...
        for doc in result:
            ...
            for i in doc_query_pro.argsort()[::-1]:
                if lemmatiser:
                    ...
                    cross_product_list = []
                    try:
                        cross_product_list.append(reverse_lem[vectorizer.get_feature_names_out()[i]])
                    except:
                    ...
                    if vectorizer.get_feature_names_out()[i] in terms:
                        explainable_terms.append((vectorizer.get_feature_names_out()[i], doc_query_pro[i]))
                        if len(explainable_terms) >= 10:
                            break
